...
from vtk.vtkIOKitPython import vtkPNGReader
# scikit-surgery imports to set up the camera from OpenCV calibration
from utils import set_camera_pose, set_camera_intrinsics
...
basedir = r'/home/SENSETIME/xulixin2/下载/SERV-CT-ALL'
...
print("Setting right camera params ({}=={}), {}, {}".format(P2[0, 0], P2[1, 1], P2[0, 2], P2[1, 2]))
style.r_fx = P2[0, 0]
style.r_fy = P2[1, 1]
style.r_cx = P2[0, 2]
style.r_cy = P2[1, 2]
